...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> mensagemNotFoundExceptions(RuntimeException ex) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
    ...
    @ExceptionHandler(MensagemForBidden.class)
    public final ResponseEntity<ApiError> mensagemForBiddenExceptions(RuntimeException ex) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
    ...
    @ExceptionHandler(MensagemFoundException.class)
    public final ResponseEntity<ApiError> mensagemFoundExceptions(RuntimeException ex) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
